...
return array(
    'service_manager' => array(
        'invokables' => array(
            'Plugin\EventManager\Repository' => 'Plugin\EventManager\Repository\EventList',
        ),
        'factories' => array(
    ...
    'plugin_adapter' => array(
        'Plugin\EventManager' => 'Zend\Db\Adapter\AdapterServiceFactory'
    ),
    'db' => array(
        'driver' => 'Pdo_Mysql',
        'username' => 'root',
        'password' => '',
        'dsn' => 'mysql:dbname=cauldron;host=localhost',
    )
);
 *
 */
